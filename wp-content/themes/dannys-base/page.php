...
<div id="content">
  ...
  <div class="post hentry<?php if (function_exists('sticky_class')) { sticky_class(); } ?>">
    ...
    <div class="main entry-content group">
      ...
      <span class="home-post-thumb"> <a href="<?php echo $url ?>" rel="lightbox">
    ...
    <div class="meta group">
      <div class="signature">
        <p class="author vcard">Written by <span class="fn">
          <?php the_author() ?>
          </span> <span class="edit">
          <?php edit_post_link('Edit'); ?>
          </span></p>
        <p><abbr class="updated" title="<?php the_time('Y-m-d\TH:i:s')?>">
          <?php the_time('F jS, Y'); ?>
          <?php _e('at', 'Gaia-Journalist'); ?>
          <?php the_time('g:i a'); ?>
          </abbr></p>
      </div>
      <div class="tags">
